## TASK:  Combine the attacks you have learned in this module to obtain the flag.<br>
the first thing I saw was the application screen with the login panel :<br>
...
After logging in, I was redirected to /profile.php, it didn't catch my attention at first.<br>  
